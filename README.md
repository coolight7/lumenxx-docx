...
- 已经支持的模型：
  ...
  - 文件工具；批量重命名、批量平铺移动
  - [Llama.cpp](https://github.com/ggml-org/llama.cpp)；本地运行 多模态语言模型
  - [StableDiffusion.cpp](https://github.com/leejet/stable-diffusion.cpp)；本地运行 文本/图像 生成 图片/视频
...
| -                                  | -                                  |
| ---------------------------------- | ---------------------------------- |
| ![alt text](res/image/image-1.png) | ![alt text](res/image/image-2.png) |
| ![alt text](res/image/image-3.png) | ![alt text](res/image/image-4.png) |
